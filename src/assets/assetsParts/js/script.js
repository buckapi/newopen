...
const activeClassAction = function(toggle, target) {
    ...
    to && ta && (to.addEventListener("click", (function(e) {
        ...
        triggerItem.classList.contains("active") ? (triggerItem.classList.remove("active"),
        ta.classList.remove("active")) : (triggerItem.classList.add("active"),
        ta.classList.add("active"))
    }
    )),
    document.addEventListener("click", (function(event) {
        event.target.closest(toggle) || event.target.classList.contains(toggle.replace(/\./, "")) || event.target.closest(target) || event.target.classList.contains(target.replace(/\./, "")) || (to.classList.remove("active"),
...
function offcanvsSidebar(openTrigger, closeTrigger, wrapper) {
    ...
    function handleBodyClass(evt) {
        ...
        eventTarget.closest(wrapper) || eventTarget.closest(openTrigger) || (WrapperSidebar.classList.remove("active"),
    ...
    OpenTriggerprimary__btn && WrapperSidebar && OpenTriggerprimary__btn.forEach((function(singleItem) {
        singleItem.addEventListener("click", (function(e) {
            null != e.target.dataset.offcanvas && (WrapperSidebar.classList.add("active"),
    ...
    closeTriggerprimary__btn && WrapperSidebar && closeTriggerprimary__btn.addEventListener("click", (function(e) {
        null != e.target.dataset.offcanvas && (WrapperSidebar.classList.remove("active"),
        document.querySelector("body").classList.remove(`${wrapperOverlay}_active`),
    ...
    document.querySelectorAll(accordionWrapper).forEach((function(item) {
        item.addEventListener("click", (function(evt) {
            ...
            if (itemTarget.classList.contains("accordion__items--button") || itemTarget.classList.contains("widget__categories--menu__label")) {
                ...
                singleAccordionWrapper.classList.contains("active") ? (singleAccordionWrapper.classList.remove("active"),
                slideUp(singleAccordionBody)) : (singleAccordionWrapper.classList.add("active"),
...
//             footerWidget.classList.contains("active") ? (footerWidget.classList.remove("active"),
//             slideUp(footerWidgetInner)) : (footerWidget.classList.add("active"),
...
//         window.outerWidth >= 768 && (item.classList.remove("active"),
...
let wrapper = document.getElementById("funfactId");
if (wrapper) {
...
const offcanvasHeader = function() {
    ...
    offcanvasOpen && offcanvasOpen.addEventListener("click", (function(e) {
        e.preventDefault(),
        null != e.target.dataset.offcanvas && (offcanvasHeader.classList.add("open"),
        body.classList.add("mobile_menu_open"))
    }
    )),
    offcanvasClose && offcanvasClose.addEventListener("click", (function(e) {
        e.preventDefault(),
        null != e.target.dataset.offcanvas && (offcanvasHeader.classList.remove("open"),
    ...
    mobileMenuWrapper && mobileMenuWrapper.addEventListener("click", (function(e) {
        ...
        if (targetElement.classList.contains("offcanvas__sub_menu_toggle")) {
            ...
            parent.classList.contains("active") ? (targetElement.classList.remove("active"),
    ...
    offcanvasHeader && document.addEventListener("click", (function(event) {
        event.target.closest(".offcanvas__header--menu__open--btn") || event.target.classList.contains(".offcanvas__header--menu__open--btn".replace(/\./, "")) || event.target.closest(".offcanvas__header") || event.target.classList.contains(".offcanvas__header".replace(/\./, "")) || (offcanvasHeader.classList.remove("open"),
        body.classList.remove("mobile_menu_open"))
    }
    )),
    offcanvasHeader && window.addEventListener("resize", (function() {
        window.outerWidth >= 992 && (offcanvasHeader.classList.remove("open"),
        body.classList.remove("mobile_menu_open"))
    }
    ))
};
...
const newsletterPopup = function() {
    ...
    newsletterWrapper && null == popuDontShowMode && window.addEventListener("load", event=>{
        setTimeout((function() {
            ...
            document.addEventListener("click", (function(event) {
                event.target.closest(".newsletter__popup--inner") || (document.body.classList.remove("overlay__active"),
